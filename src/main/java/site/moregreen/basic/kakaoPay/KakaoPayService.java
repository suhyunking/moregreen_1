...
public class KakaoPayService {
    ...
    public String kakaoPayReady(FundingDto fundingDto, PurchaseDto purchaseDto, DeliveryDto deliveryDto, MemberDto memberDto) {
        ...
        params.add("approval_url", "http://13.124.87.77:8080/moregreen/funding/fundingPurchaseResult");
        params.add("cancel_url", "http://13.124.87.77:8080/moregreen/funding/fundingPurchaseCancel");
        params.add("fail_url", "http://13.124.87.77:8080/moregreen/funding/fundingPurchaseFail");
